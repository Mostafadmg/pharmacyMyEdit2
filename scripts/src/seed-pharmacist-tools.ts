...
const REPLIES = [
  { id: "rep-await-photo", title: "Awaiting clearer photo", body: "Thanks for your consultation. To make a safe clinical decision I need a clearer photograph of the affected area in good daylight — please ensure it is in focus and includes a 1cm reference (e.g. a coin) for scale.", category: "admin", statusContext: "more_info_needed", conditionId: null },
  { id: "rep-bp-reading", title: "Need recent BP reading", body: "Before I can issue this medication I need a blood pressure reading from the last 6 months. Please measure at home or at any pharmacy and reply with the systolic and diastolic values.", category: "admin", statusContext: "more_info_needed", conditionId: null },
  { id: "rep-gp-shared", title: "Shared with your GP", body: "I have shared this consultation with your GP surgery for their records. There is nothing further you need to do, and your medication will be dispatched today.", category: "follow_up", statusContext: "approved", conditionId: null },
  { id: "rep-not-suitable", title: "Not suitable for online care", body: "After careful review I do not feel it would be safe to manage this presentation through an online consultation. I'd recommend an in-person assessment with your GP or NHS 111 if symptoms are progressing.", category: "safety", statusContext: "rejected", conditionId: null },
  { id: "rep-red-flag-111", title: "Refer to NHS 111", body: "Some of the symptoms you describe are red-flag and need same-day assessment. Please contact NHS 111 (or 999 if you feel unwell quickly) and let them know what you have told me here.", category: "safety", statusContext: "rejected", conditionId: null },
  { id: "rep-wait-7days", title: "Self-care first 7 days", body: "Most cases improve with self-care. Please try over-the-counter relief, rest and hydration for 7 days. If symptoms persist or worsen, restart your consultation and we will reassess.", category: "safety", statusContext: "rejected", conditionId: null },
  { id: "rep-allergy-check", title: "Confirm allergy details", body: "Before prescribing I need to confirm exactly what reaction you had previously and to which medication. Please reply with as much detail as possible (rash, swelling, breathing difficulty etc.).", category: "admin", statusContext: "more_info_needed", conditionId: null },
  { id: "rep-pregnancy", title: "Confirm pregnancy/breastfeeding", body: "This medication has specific guidance in pregnancy and breastfeeding. Please confirm whether either applies to you (or could apply) before I can prescribe.", category: "admin", statusContext: "more_info_needed", conditionId: null },
  { id: "rep-dispatch-today", title: "Order dispatched today", body: "Good news — your prescription has been approved and your order will be dispatched today via Royal Mail Tracked. You will receive a tracking link by email shortly.", category: "follow_up", statusContext: "approved", conditionId: null },
  { id: "rep-take-with-food", title: "Take with food reminder", body: "A quick safety reminder — please take this medication with food to reduce the chance of stomach upset, and complete the full course even if you feel better.", category: "follow_up", statusContext: "approved", conditionId: null },
];
