...
export function productCardSvg(name: string, category: string): string {
  ...
  <text x="200" y="168" text-anchor="middle" font-family="Segoe UI, Helvetica, Arial, sans-serif" font-size="11" font-weight="700" letter-spacing="0.12em" fill="${accent}">PHARMACARE</text>
  ${lineEls}
