...
export const WL_ORAL_EXCLUDED_MEDICATIONS = [
  { id: "insulin", label: "Insulin (for diabetes)" },
  {
    id: "sulfonylureas",
    label:
  ...
  },
  {
    ...
    label: "Oral contraceptive pill (combined or progesterone-only)",
  },
  {
  ...
  },
  {
    ...
    label: "Other anti-obesity or weight-loss drugs",
  },
  {
    id: "weight_loss_injections",
    label: "Weight-loss injections (e.g. Mounjaro, Wegovy)",
  },
] as const;
