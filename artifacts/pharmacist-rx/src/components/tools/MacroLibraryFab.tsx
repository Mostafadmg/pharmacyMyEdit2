  ...
  return (
    <div className="pointer-events-none sticky bottom-20 z-40 flex justify-start pl-4">
      <div ref={wrapRef} className="pointer-events-auto relative max-w-[calc(100vw-1rem)]">
        {open ? (
          <div
            className="absolute bottom-full left-0 mb-3 flex w-[min(42rem,calc(100vw-2rem))] max-h-[min(calc(100dvh-7rem),40rem)] flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-2xl"
            role="dialog"
