...
import { Package, Truck, Check, Clock, ArrowRight, ShoppingBag } from "lucide-react";
                  ...
                  <Link href={`/order-confirmation/${o.id}`}>
                    <Card className="border-0 bg-white rounded-2xl hover:shadow-md transition-shadow cursor-pointer">
                      <CardContent className="p-5 flex items-center gap-4 flex-wrap">
                        <div className="w-12 h-12 rounded-full bg-[#168A7B]/10 flex items-center justify-center flex-shrink-0">
                          <Icon className="w-5 h-5 text-[#168A7B]" />
                        </div>
