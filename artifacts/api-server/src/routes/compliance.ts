  ...
  try {
    ...
    const [consultation] = await db
      ...
      .values({
        ...
        hasRedFlag,
        hasPhoto: !!b.hasPhoto,
        photoUrls: Array.isArray(b.photoUrls) ? b.photoUrls.filter((u: unknown) => typeof u === "string").slice(0, 6) : [],
        ...
        identityVerificationMethod: (typeof b.identityVerificationRef === "string" && b.identityVerificationRef.trim()) ? (b.identityVerificationMethod ?? null) : null,
        identityVerificationRef: (typeof b.identityVerificationRef === "string" && b.identityVerificationRef.trim()) ? b.identityVerificationRef.trim() : null,
        identityVerifiedAt: (typeof b.identityVerificationRef === "string" && b.identityVerificationRef.trim()) ? new Date() : null,
